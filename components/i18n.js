const i18n = (lang, word) => {
  const vocabular = {
    ...
    positive_absolute_amount: {en: 'Positive Absolute Amount', ua: 'Сума Позитивне число',},
    ...
    amount_number: {en: 'must be a Number!', ua: 'Потрібне число!',},
    start_after_end: {en: 'Start must come before the End!', ua: 'Початок має бути перед Кінцем!',},
